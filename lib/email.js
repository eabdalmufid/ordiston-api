    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api Ordiston - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6287782830020">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>Eabdalmufid</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Ordiston" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api Ordiston`,
        html: inboxGmail,
      };
